...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim training, technique drills, and pool games",
    ...
    "Photography Club": {
        "description": "Learn photography skills and share creative photo projects",
        "schedule": "Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["zoe@mergington.edu", "ian@mergington.edu"]
    },
    "Debate Society": {
        "description": "Build public speaking skills and discuss current events",
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["amy@mergington.edu", "kevin@mergington.edu"]
    }
}
